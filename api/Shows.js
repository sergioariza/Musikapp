module.exports = function(app, apiRoutes, Shows) {
    ...
    apiRoutes.post('/shows', function(req, res) {
        var shows = new Shows({
            user: req.body.user,
            id: req.body.id,
    ...
    apiRoutes.put('/shows', function(req, res) {
    ...
    apiRoutes.delete('/shows/:user/:id', function(req, res) {
        return Shows.findOne({
            "user": req.params.user,
            "id": req.params.id
        }, function(err, shows) {
